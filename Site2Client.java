...
public class Site1Client {
	...
	public static void main(String[] args) {
		int i=0, failed_sites = 0, site_id = 1;
		String tsites 	= (args.length < 1) ? "2" : args[0];
		String cord 	= (args.length > 1) ? args[0] : "1";
		...
		try {
			...
			ThreePCInterface stub 	= (ThreePCInterface) registry.lookup("Site1Server");
			ThreePCInterface site2 	= (ThreePCInterface) registry.lookup("Site2Server");
			siteX[i] = site2;	sites[i] = 2; 	i++;
			ThreePCInterface site3 	= (ThreePCInterface) registry.lookup("Site3Server");
			siteX[i] = site3;	sites[i] = 3;	i++;
